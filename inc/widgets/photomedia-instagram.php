...
----------------------------------------*/
class photomedia_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('photomedia_instagram_photo',esc_html__('[ Photomedia ] Intagram Photo','photomedia'),array(
			'description' => esc_html__('Photomedia Instagram Photo Widget','photomedia'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'photomedia');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'photomedia'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'photomedia'); ?></label>
...
if(!function_exists('photomedia_instagram_widgets')):
	function photomedia_instagram_widgets(){
		register_widget('photomedia_instagram_photo');
	}
	add_action('widgets_init','photomedia_instagram_widgets');
endif;
