...
// image default alt
if( !function_exists( 'photomedia_img_default_alt' ) ){
	function photomedia_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'photomedia_img_tag' ) ){
	function photomedia_img_tag( array $args ){
		...
		if( !empty( $args['alt'] ) ){
			...
			$alt = photomedia_img_default_alt( $url );
		}
...
// Anchor Tag
if( !function_exists( 'photomedia_anchor_tag' ) ){
	function photomedia_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'photomedia_heading_tag' ) ){
	function photomedia_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'photomedia_paragraph_tag' ) ){
	function photomedia_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'photomedia_other_tag' ) ){
	function photomedia_other_tag( array $args ){
...
// Button Element 
if( !function_exists( 'photomedia_button_element ' ) ){
	function photomedia_button_element( array $args ){
