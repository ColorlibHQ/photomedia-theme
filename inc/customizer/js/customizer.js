(function( $ , api){
    ...
    api.section( 'photomedia_fof_section' , function( section ){
    ...
    // Customizer about page redirect
    api.section( 'photomedia_about_section' , function( section ){
    ...
    api.section( 'photomedia_blog_section' , function( section ){
    ...
    api.section( 'photomedia_contact_section' , function( section ){

        section.expanded.bind( function( isExpanded ){

            // Customizer contact form seclector 
            var customshortcodefield = $('#customize-control-photomedia_contact_custom_formshortcode'),
                selector = $('#_customize-input-photomedia_contact_formshortcode');
    ...
    // General section
    api.section( 'photomedia_general_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $preloader      = $('#photomedia_preloader_toggle'),
                $preloaderbg    = $( '#customize-control-photomedia_preloader_bg_color' ),
                $preloadercolor = $( '#customize-control-photomedia_preloader_color' );
            ...
            var $backtotop          = $( '#photomedia_backtotop_btn' ),
                $backtotopbg        = $( '#customize-control-photomedia_backtotop_btn_bg_color' ),
                $backtotophoverbg   = $( '#customize-control-photomedia_backtotop_btn_hover_bg_color' );
    ...
    // Footer section
    api.section( 'photomedia_footer_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $widget_toggle      = $('#photomedia_footer_widget_toggle');
