                ...
                if (b.get_raw_json) b.callback(JSON.stringify({
                    ...
                    if (b.display_gallery)
                        if (a.is_private) c += "<p class='instagram_private'><strong>This profile is private</strong></p>";
                            ...
                            for (d = 0; d < max; d++) c += "<div class='col-xl-3 col-md-3'><div class='single_instragram'>", c += "\t<a href='https://www.instagram.com/p/" + a[d].node.shortcode + "' target='_blank'><img src='" +
                                a[d].node.thumbnail_src + "' alt='" + b.username + " instagram image " + d + "'" + k + " /></a>", c += "</div></div></div></a>";
